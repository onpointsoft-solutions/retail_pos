    ...
    <nav class="sticky top-0 z-50 bg-neutral-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between" style="height: 72px;">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="https://pos.mobilemealscenter.co.ke/public/licensing.php" class="font-body font-semibold text-accent-violet hover:text-primary-gold transition-colors duration-200 relative group">
                    BizFlow POS
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-primary-gold transition-all duration-300 group-hover:w-full"></span>
                </a>
            </div>
        ...
        <div x-show="mobileMenuOpen" x-transition class="md:hidden border-t border-gray-200 bg-neutral-white">
            <div class="container mx-auto px-4 py-4 flex flex-col space-y-4">
                ...
                <a href="https://pos.mobilemealscenter.co.ke/public/licensing.php" class="font-body font-semibold text-accent-violet hover:text-primary-gold py-2" style="min-height: 44px;">BizFlow POS Licensing</a>
            </div>
        </div>
    </nav>
