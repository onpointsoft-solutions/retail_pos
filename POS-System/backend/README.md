...
The PHP pricing site in `backend/public` initializes Paystack transactions on the server, verifies
...
The shop and API must point to the same licensing MySQL database.
