...
public class OrderEntryPanel extends JPanel {
    ...
    private JPanel createMenuItemsPanel() {
        ...
        menuItemsPanel.add(categoryTabs, BorderLayout.CENTER);
    ...
    private void setupEventHandlers() {
        ...
        orderManager.setOrderListener(new OrderManager.OrderListener() {
            ...
            @Override
            public void onOrderSubmitted(OrderManager.POSOrder order) {
            ...
            @Override
            public void onOrderCancelled(OrderManager.POSOrder order) {
    ...
    private void updateTotals() {
        ...
        java.text.DecimalFormat df = new java.text.DecimalFormat("KES #,##0.00");
    ...
    private class OrderItemsTableModel extends javax.swing.table.AbstractTableModel {
        ...
        private java.util.List<OrderManager.OrderItem> items = new java.util.ArrayList<>();
